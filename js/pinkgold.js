...
function handlepinkGoldPage_specDetails1() {
    ...
    gsap.fromTo('.pinkGold__spec-1-text',{rotationX:"-90deg"},{duration:1,rotationX:"0deg"});
...
function handlepinkGoldPage_specDetails2() {
    ...
    gsap.fromTo('.pinkGold__spec-2-text',{rotationX:"-90deg"},{duration:1,rotationX:"0deg"});
...
function handlepinkGoldPage_specDetails3() {
    ...
    gsap.fromTo('.solidLine',{opacity:0,width:'0%'},{duration:1,opacity:1,width:'50%'});
    gsap.fromTo('.pinkGold__spec-3-text',{rotationX:"-90deg"},{duration:1,rotationX:"0deg"});
...
function handlepinkGoldPage_specDetails4() {
    ...
    gsap.fromTo('.solidLine',{opacity:0,width:'0%'},{duration:1,opacity:1,width:'50%'});
    gsap.fromTo('.pinkGold__spec-4-text',{rotationX:"-90deg"},{duration:1,rotationX:"0deg"});
...
function handlepinkGoldPage_specDetails5() {
    ...
    gsap.fromTo('.pinkGold__spec-5-text',{rotationX:"-90deg"},{duration:1,rotationX:"0deg"});
...
function swapPageToWhiteGold() {
    ...
    gsap.to('.watchPage__whiteGold-Header-title',{duration:0.5,delay:0.3,opacity:1});
    gsap.to('#watchPage__whiteGold-Scene',{duration:1.2,delay:1.3,opacity:1,onComplete:function(){
        clickcount_pinkGold_toPinkGold =0;
        clickcount_pinkGold_toWhiteGold =0;
