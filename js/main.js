...
var ts_hp = document.getElementById('touchSurface_homePage');
    ...
    swipedetect(ts_hp, function(swipedir){
        if (swipedir != 'none'){
            ...
            gsap.to('#homePage_scene',{duration:1.5,opacity:0});
...
function completeReverseWhiteGoldHandler() {
    ...
    gsap.fromTo('.watchPage__whiteGold-selected',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,opacity:1,delay:2,y:'0%',boxShadow:"1px 1px 8px 13px #747474",border: "none"});
    ...
    gsap.fromTo('#watchPage__whiteGold__gallery',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,delay:3.3,opacity:1,y:'0%',boxShadow:"1px 1px 8px 13px #f6f6f6",border: "2px solid white",onComplete: function(){smokeText_whiteGold.style.display="none";}});
    } else {
    ...
    gsap.fromTo('.watchPage__pinkGold-Header-title',{opacity:0},{duration:2,delay:1,opacity:1,onComplete:function() {
        if(whiteGold_360Image!==1){
             window.CI360.init();
             whiteGold_360Image=1;
        }
    }});
    gsap.fromTo('#watchPage__pinkGold-Scene',{opacity:0},{duration:3,delay:2,opacity:1});
    gsap.fromTo('.watchPage__pinkGold-selected',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,opacity:1,delay:2,y:'0%',boxShadow:"1px 1px 8px 13px #747474",border: "none"});
    gsap.fromTo('#watchPage__pinkGold__toWhiteGold',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,opacity:1,delay:2.3,y:'0%',boxShadow:"1px 1px 8px 13px #f6f6f6",border: "2px solid white"});
    gsap.fromTo('#watchPage__pinkGold__video',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,opacity:1,delay:2.6,y:'0%',boxShadow:"1px 1px 8px 13px #f6f6f6",border: "2px solid white"});
    gsap.fromTo('#watchPage__pinkGold__spec',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,delay:3,opacity:1,y:'0%',boxShadow:"1px 1px 8px 13px #f6f6f6",border: "2px solid white"});
    gsap.fromTo('#watchPage__pinkGold__gallery',{y:'-100%',opacity:0,boxShadow:'0 0 0 0 #ffffff',border: "none"},{duration:1.5,delay:3.3,opacity:1,y:'0%',boxShadow:"1px 1px 8px 13px #f6f6f6",border: "2px solid white",onComplete: function(){smokeText_pinkGold.style.display="none";}});    }
}
