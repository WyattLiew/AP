...
const mainPage_timeline = gsap.timeline({defaults:{duration:1}});
...
function storyEndHandler(e) {
            gsap.to('#story',{duration:2,opacity:0});
...
function completeReverseWhiteGoldHandler() {
 ...
 for (var i = 0; i <smokeTextSpan.length; i++) {
    ...
    gsap.fromTo('.watchPage__whiteGold-Header-title',{opacity:0},{duration:2,delay:1,opacity:1});
    gsap.fromTo('#watchPage__whiteGold-Scene',{opacity:0},{duration:3,delay:1.5,opacity:1});
