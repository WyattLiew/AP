...
function swapPageToPinkGold() {
    ...
    gsap.to('.watchPage__pinkGold-Header-title',{duration:0.5,delay:0.3,opacity:1});
    gsap.to('#watchPage__pinkGold-Scene',{duration:1.2,delay:1.3,opacity:1,onComplete:function(){
        clickcount_pinkGold_toPinkGold =0;
        clickcount_pinkGold_toWhiteGold =0;
